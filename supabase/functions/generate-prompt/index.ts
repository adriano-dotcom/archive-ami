...
Deno.serve(async (req) => {
  ...
  <knowledge_base>
    ...
    <regulatory_faq>
      <!-- Seção de FAQ regulatório removida — não aplicável ao contexto OrbePet -->
    </regulatory_faq>
  </knowledge_base>
  ...
  <guidelines>
    ...
    <objection_handling>
      **Objeções comuns:**
      ...
      1. **Validar o sentimento:** "Eu te entendo!"
      2. **Normalizar:** "A maioria das pessoas tem essa mesma impressão no começo."
      3. **Remover pressão:** "Sem compromisso nenhum."
      4. **Manter porta aberta:** "Quando precisar, me chama aqui!"
    </objection_handling>
  </guidelines>
