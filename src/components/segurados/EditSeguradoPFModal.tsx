...
interface EditSeguradoPFModalProps {
  open: boolean;
  segurado: SeguradoPF | null;
...
export const EditSeguradoPFModal: React.FC<EditSeguradoPFModalProps> = ({
  open,
  segurado,
  onOpenChange,
  onSuccess
  ...
  const loadContactData = async (contactId: string) => {
    ...
    try {
      ...
      toast.error('Erro ao carregar dados do segurado');
    } finally {
...
export default EditSeguradoPFModal;
