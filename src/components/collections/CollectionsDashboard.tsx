    ...
    <div className="h-full flex flex-col overflow-hidden bg-slate-950">
      ...
      <div className="flex-shrink-0 p-6 pb-4">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">Apólices & Cobrança</h1>
            <p className="text-sm text-slate-400">Gestão de apólices, inadimplência e parcelas vencidas</p>
          </div>
        </div>
      </div>
