...
import { LayoutDashboard, MessageSquare, Users, Settings as SettingsIcon, LogOut, ShieldCheck, Calendar, Kanban, Code2, Megaphone, Target, Receipt, MessageCircle } from 'lucide-react';
...
const allMenuItems = [
  ...
  { id: 'prospecting', label: 'Prospecção', icon: Megaphone, adminOnly: false },
