...
const UnreadPreviewPanel = () => {
  ...
  return <motion.div initial={{
    ...
    damping: 25
      ...
      {unreadConversations.length > 5 && <Link to="/chat" className="block text-center text-xs bg-gradient-to-r from-cyan-400 to-teal-400 bg-clip-text text-transparent font-medium hover:from-cyan-300 hover:to-teal-300 mt-3 py-2 hover:bg-white/[0.03] rounded-lg transition-all">
